...
export const prospects = pgTable(
  "prospects",
  {
    ...
    apolloReplyData: jsonb("apollo_reply_data"),
  ...
  (table) => ({
    slugIdx: index("idx_prospects_slug").on(table.slug),
    statusIdx: index("idx_prospects_status").on(table.status),
    createdAtIdx: index("idx_prospects_createdAt").on(table.createdAt),
  })
);
...
export const listings = pgTable(
  ...
  (table) => ({
    prospectIdIdx: index("idx_listings_prospectId").on(table.prospectId),
    asinIdx: index("idx_listings_asin").on(table.asin),
    createdAtIdx: index("idx_listings_createdAt").on(table.createdAt),
  })
);
...
export const listingAnalyses = pgTable(
  ...
  (table) => ({
    listingIdIdx: index("idx_analyses_listingId").on(table.listingId),
    prospectIdIdx: index("idx_analyses_prospectId").on(table.prospectId),
    createdAtIdx: index("idx_analyses_createdAt").on(table.createdAt),
  })
);
...
export const bookings = pgTable(
  ...
  (table) => ({
    prospectIdIdx: index("idx_bookings_prospectId").on(table.prospectId),
...
export const prospectActivities = pgTable(
  ...
  (table) => ({
    prospectIdIdx: index("idx_activities_prospectId").on(table.prospectId),
    eventTypeIdx: index("idx_activities_eventType").on(table.eventType),
...
export const rufusQueries = pgTable(
  "rufus_queries",
  {
    id: serial("id").primaryKey(),
    prospectId: integer("prospect_id")
  ...
  (table) => ({
    prospectIdIdx: index("idx_rufus_queries_prospectId").on(table.prospectId),
  })
);
...
export const catalogLinks = pgTable(
  ...
  (table) => ({
    prospectIdIdx: index("idx_catalog_links_prospectId").on(table.prospectId),
  })
);
